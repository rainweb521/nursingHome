...
//		退出功能
		...
		@RequestMapping(value="/register",method=RequestMethod.GET)
		 public String register( ){
			String blank = "/register";
			return blank;
		}
		@RequestMapping(value="/register",method=RequestMethod.POST)
		 public ModelAndView register(ModelAndView mv,@ModelAttribute User job){
			Date date = new Date();    
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
			job.setCreate_date(sdf.format(date));
			job.setStatus(2);
			rainservice.insert_UserInfo(job);
