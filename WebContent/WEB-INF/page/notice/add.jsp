  ...
  <body>
    <div class="x-body">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>营养价值
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="pabulum" name="pabulum" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${job.pabulum }">
              </div>
          ...
          <div class="layui-form-item">
              <label for="username" class="layui-form-label">
                  <span class="x-red">*</span>热量
              </label>
              <div class="layui-input-inline">
                  <input type="text" id="heat" name="heat" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${job.heat }">
              </div>
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="date" id="create_date" name="create_date" required="" lay-verify="required"
