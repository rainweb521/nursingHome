...
<html>
  ...
  <body>
    <div class="x-nav">
     ...
     <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="${ctx }/notice/now" title="刷新">
 ...
 <!--        <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量删除</button> -->
      ...
      <button class="layui-btn" onclick="x_admin_show('添加菜品','${ctx}/notice/add')"><i class="layui-icon"></i>添加</button>
