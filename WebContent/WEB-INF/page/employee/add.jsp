        ...
        <input type="hidden" name="id" id="id" value="${job.id }" >
          ...
          <div class="layui-form-item" >
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="address" name="address" placeholder="" required="" lay-verify="required"
           ...
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="date" id="begin" name="begin" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${job.begin }">
              </div>
          </div>
           <div class="layui-form-item">
              <label for="phone" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  <input type="date" id="end" name="end" required="" lay-verify="required"
                  autocomplete="off" class="layui-input" value="${job.end }">
              </div>
          </div>
           <div class="layui-form-item">
              <label for="phone" class="layui-form-label">
              ...
              <div class="layui-input-inline">
                  ...
                  autocomplete="off" class="layui-input" value="${job.num }">
              </div>
          </div>
